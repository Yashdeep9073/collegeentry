...
<template>
  ...
  >
    <div class="form_container relative animate-[fadeIn_.3s]  overflow-y-auto max-h-[99vh]">
      ...
      <div class="w-full space-y-3">
        <div class="input_container">
          ...
          <svg fill="none" viewBox="0 0 24 24" height="24" width="24" xmlns="http://www.w3.org/2000/svg" class="icon"><path stroke-linecap="round" stroke-width="1.5" stroke="#141B34" d="M12 21C16.9706 21 21 16.9706 21 12C21 7.02944 16.9706 3 12 3C7.02944 3 3 7.02944 3 12C3 16.9706 7.02944 21 12 21Z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" stroke="#141B34" d="M12 11C13.6569 11 15 9.65685 15 8C15 6.34315 13.6569 5 12 5C10.3431 5 9 6.34315 9 8C9 9.65685 10.3431 11 12 11Z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" stroke="#141B34" d="M7 17.5C7.91721 15.6025 9.80517 14.3333 12 14.3333C14.1948 14.3333 16.0828 15.6025 17 17.5"></path></svg>
          <input
            v-model="form.name"
            type="text"
        ...
        <div class="input_container">
          ...
          <svg fill="none" viewBox="0 0 24 24" height="24" width="24" xmlns="http://www.w3.org/2000/svg" class="icon"><path stroke-linecap="round" stroke-width="1.5" stroke="#141B34" d="M14.954 18.918C14.155 18.846 13.355 18.784 12.56 18.732C10.74 18.61 8.998 18.423 7.322 17.864C5.165 17.135 3.39 15.698 2.373 13.629C1.356 11.56 1.139 9.172 1.954 6.84C2.651 4.78 3.966 3.016 5.617 1.838C6.67 1.109 7.824 0.65 9.013 0.44C11.535 0.007 14.225 0.384 16.653 1.58C18.435 2.455 20.04 3.91 21.144 5.69C21.722 6.643 22.083 7.697 22.257 8.783"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" stroke="#141B34" d="M22 13V22M22 13L15.42 13C12.448 13 11 14.475 11 17.425V18.575C11 21.525 12.448 23 15.42 23H22V13Z"></path></svg>
          <input
            v-model="form.phone"
            type="tel"
...
Below are the styles needed for the new design. Note that I've adjusted the primary button color (`.sign-in_btn`) to match your header's orange (`#FF5C00`) for consistency, as done in the Login modal conversion.
